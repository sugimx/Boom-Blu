...
export const metadata: Metadata = {
  ...
  description:
    'Boom Blu premium washing liquid for powerful stain removal, long-lasting freshness, and fabric care. Perfect for machine and hand wash. By Sugimx Private Limited.',
  icons: {
