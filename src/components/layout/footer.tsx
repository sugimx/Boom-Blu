            ...
            <div className="lg:col-span-3 xl:col-span-4">
              <div>
                ...
                <p className="block text-sm text-gray-400 mb-9">
                  Boom Blu is a premium washing liquid brand from Sugimx Private Limited. We deliver powerful stain removal with refreshing fragrance and fabric-friendly formula for families everywhere.
                </p>
                <div className="flex">
                  <a
        ...
        <div className="container relative z-10 px-5 mx-auto sm:px-7">
          <div className="py-5 text-center">
            <p className="text-sm text-gray-500">
              &copy; {getCurrentYear()} Boom Blu - All Rights Reserved.
            </p>
          </div>
        </div>
      </div>
